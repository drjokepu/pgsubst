# pgsubst [![Build Status](https://app.travis-ci.com/drjokepu/pgsubst.svg?branch=master)](https://travis-ci.org/drjokepu/pgsubst) [![NPM version](https://badge.fury.io/js/pgsubst.png)](http://badge.fury.io/js/pgsubst)
